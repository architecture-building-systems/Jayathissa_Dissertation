...
\input{chapters/ch2asfSimulation/B1_introduction}

\section{Methodology}
\label{ch:method2}
\input{chapters/ch2asfSimulation/B2_methodology}

\section{Results}
\label{ch:results2}
\input{chapters/ch2asfSimulation/B3_results}
...
\input{chapters/ch2asfSimulation/B6_conclusion}
...
% \begin{appendices}
%  \label{ch:appendix}
%  \input{chapters/ch2asfSimulation/B8_appendix}
%  \end{appendices}
